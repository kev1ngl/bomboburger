...
<head>
  <meta charset="utf-8" />
  <title>Portal Empleados | Panel</title>
    ...
    <div class="app-header navbar">
      <div class="navbar-header bg-dark">
        ...
        <a href="admin.php" class="navbar-brand text-lt">
          ...
          <span class="hidden-folded m-l-xs">BomboBurger</span>
        </a>
      </div>
        ...
        <div class="navi-wrap">
          ...
          <nav ui-nav class="navi">
            ...
            <li>
              <a href class="auto">
                <span class="pull-right text-muted">
                  <b class="badge bg-info pull-right">TS</b>
                </span>
                <i class="fa fa-file icon text-success"></i>
                <span class="font-bold">T. SOLICITUD</span>
              </a>
              <ul class="nav nav-sub dk">
                <li ui-sref-active="active">
                ...
                <li ui-sref-active="active" onclick="cargar_contenido('main-content','Tipo_Documento/vista_tipoDocumento_Registrar.php');">
                  <a ui-sref="app.dashboard-v2">
                    <span>Nuevo Tipo de solicitud</span>
                  </a>
                </li>
              </ul>
            </li>
        ...
        <div class="panel panel-default">
          <div class="panel-body">
            <div style="text-align: center;" align="center">
              <img style="text-align: center;" align="center" src="burger.jpg">
              ...
              <div class="panel-body">
                <form method="POST" id="update-form-administrador">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="col-sm-4">
                      <input type="hidden" class="form-control" onkeypress="return soloNumeros(event)" name="dni_personal" id="dni_personal" placeholder="Ingrese DNI" maxlength="13">
                      <br>
                    </div>
                  </div>
          ...
          <form class="form-horizontal" id="formulario_usuario">
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="password" class="form-control" id="txtactual" placeholder="Contraseña Actual" maxlength="30">
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-4 control-label">Nueva </label>
                <div class="col-sm-5">
                  <input type="password" class="form-control" id="txtnueva" placeholder="Nueva Contraseña" maxlength="30">
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-4 control-label">Repetir Contraseña Nueva</label>
                <div class="col-sm-5">
                  <input type="password" class="form-control" id="txtrepetir" placeholder="Repetir Contraseña" maxlength="30">
                </div>
