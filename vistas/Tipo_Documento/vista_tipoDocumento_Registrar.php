...
<div class="contendor_kn">
	<div class="panel panel-default">
		<div class="panel-heading">
			<h2><b>REGISTRO DE TIPO DE SOLICITUD</b></h2>
			<br>
		</div>
		<div class="panel-body">
            ...
            <div class="col-md-12 col-lg-12 col-xs-12" style="text-align:center;" >
                <br><br>
                <button class="btn btn-success" onClick="Registrar_TipoDocumento()"><i class="fa fa-floppy-o"></i>&nbsp;<b>Registrar Tipo Solicitud</b></button>
            </div>
            <br>           			
        </div>
        <br>
