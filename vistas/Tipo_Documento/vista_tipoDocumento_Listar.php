...
<div class="contendor_kn">
  <div class="panel panel-default">
    <div class="panel-heading">
      <h2><b>TIPO DE SOLICITUDES REGISTRADAS</b></h2>            
    </div>
    <div class="panel-body">
      ...
      <div class="col-md-12">
        <div class="table-responsive" style="text-align: center;">
          <br>
          <label>LISTADO DE TIPO DE SOLICITUDES</label>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
         <div class="modal-header">
           ...
           <h4 class="modal-title" id="myModalLabel"><b>Editar Tipo de Solicitudes</b></h4>
         </div>
        <div class="modal-body">
              ...
              <div class="col-md-12 col-lg-12 col-xs-12" style="text-align:center;" >
                <br>
                <button class="btn btn-success" onClick="Editar_TipoDocumento()"><i class="fa fa-check"></i>&nbsp;<b>Modificar Tipo Solicitud</b></button>
              </div>
              <br>           			
            </div>
        </div>
