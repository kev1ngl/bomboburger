      ...
      <form method="POST" id="create-form-documento">
        ...
        <div class="form-group">
          ...
          <div class="col-md-5"><br>
            <!-- <label>Datos Remitente</label> -->
              <input type="hidden" id="txtdatosremitente" name="txtdatosremitente" readonly style="color: rgb(25,25,51); background-color: rgb(255,255,255);solid 5px;color:#9B0000; text-align:center;font-weight: bold;" class="form-control">
          </div>
          <!-- <div class="col-md-4"><br><label>&nbsp;</label>
            <a  type="hidden" role="button" class="btn btn-primary col-sm-12" style="width: 100%" onClick="AbrirModalRemitente()"><i class="fa fa-search"></i> <b>Seleccionar Remitente</b></a>
            <br>
          </div> -->
          <div class="col-sm-12">
        ...
        <div class="form-group">
          <div class="col-md-12" style="text-align: center;"><br>
            <br><button class="btn btn-success" onclick="Registrar_documento_post()"><strong> Registrar Solicitud</strong></button><br><br>
          </div>
        </div>
      </form>
    </div>
...
<script type="text/javascript">
  TraerCodigoDocumento();
</script>
<script type="text/javascript">
  Listar_tipodocumento_combo();
</script>
<script type="text/javascript">
  Listar_areas_combo();
</script>
          ...
          <div class="box-body">
            <div class="nav-tabs-custom">
              <ul class="nav nav-tabs pull-right">
                <li class="active"><a href="#tab_1-1" data-toggle="tab"><strong> FUNCIONARIOS </strong> </a></li>
                <li><a href="#tab_2-2" data-toggle="tab"><strong> SUCURSALES</strong></a></li>
              </ul>
              <div class="tab-content" style="width: 100%">
                <div class="tab-pane active" id="tab_1-1"><BR><BR>
                  <label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;RUN del funcionario remitente:</label>
                  <br>
                  <div class="col-md-12">
                    <div class=" input-group">
