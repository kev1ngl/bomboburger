...
<body>
	<div class="main-w3ls">
		<div class="left-content" style="text-align: center;" align="center">
			...
			<img  style="width: 90%;" src="_plantilla/images/logo_2.jpg" />
			<div class="copyright">
			</div>
		</div>
		<div class="right-form-agile">
			<div class="sub-main-w3">
				...
				<a href="seguimiento.php" class="btn btn-default" style="box-shadow: 0 0 0 .2rem rgba(0,0,0,0);">Seguimiento Solicitud</a><br><br>
